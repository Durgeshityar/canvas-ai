  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {isPro && (
          <div className="absolute top-2 right-2 h-10 w-10 flex items-center justify-center bg-black/50 rounded-full ">
            <Crown className="size-5 fill-yellow-500 text-yellow-500 -z[10]" />
          </div>
        )}
